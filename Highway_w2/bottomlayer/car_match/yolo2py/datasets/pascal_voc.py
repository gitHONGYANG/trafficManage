...
class VOCDataset(ImageDataset):
    def __init__(self, imdb_name, datadir, batch_size, im_processor,
        ...
        self._classes = ('car', 'truck', 'trailer', 'oil')
#        self._classes = ('schoolbus', 'trunk', 'truck', 'boat',
...
#                         'sheep', 'sofa', 'train', 'tvmonitor')
    ...
    def _load_image_set_index(self):
        ...
        with open(image_set_file) as f:
            #ci chu xiu gai wei zi ji de tu pian de biaoqian 
            #image_index= ['000001', '000002', '000003', '000004', '000005']
            image_index = [x.strip() for x in f.readlines()]
        return image_index  #mei yi hangde mingzi
